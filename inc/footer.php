    ...
    <section class="col-lg-12 col-sm-12 col-xs-12" id="recentfooter">
      ...
      <div class="output col-lg-3">
        ...
        <a href="<?php echo 'product.php?id=' . $product{'id'}; ?>">
          <img class="recentadd" alt="<?php echo $product{'price'}; ?>" src="<?php echo 'img/upload/' . $product{'img'}; ?>">
        </a>
      </div>
    <?php endwhile ?>
...
<div class="container copyright">
  <div class="col-lg-12"><br>
    ...
    <p class="col-lg-4 col-sm-6">Copyright <sup>&copy; </sup> Luke Briedis <?php echo date("Y"); ?></p>
    <p class="col-lg-4 col-sm-6"></p>
