...
<div id="editprod" class="col-lg-5 col-sm-6 col-xs-12 adminbox">
  ...
  <input type="hidden" name="type" value="editproduct">
   ...
   <div class="form-group">
     ...
     <div class="col-sm-8">
       <input <?php if(!isset($_GET['id'])) {echo 'disabled';}?> value="<?php if(isset($_GET['id'])) {echo $prod{0}{"price"};} ?>" class="form-control" name="price" type="text" required>
     </div>
   </div>
   ...
   <div class="form-group">
     ...
     <div class="col-sm-8">
       <input <?php if(!isset($_GET['id'])) {echo 'disabled';}?> value="<?php if(isset($_GET['id'])) {echo $prod{0}{"sku"};} ?>" class="form-control"  name="sku" type="text" required>
     </div>
   </div>
